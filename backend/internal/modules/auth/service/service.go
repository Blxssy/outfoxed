...
func generateGuestUsername() string {
	adjectives := []string{
		"Весёлый", "Хитрый", "Смелый", "Добрый", "Шустрый",
		"Ловкий", "Быстрый", "Яркий", "Смешной", "Милый",
		"Забавный", "Солнечный", "Пушистый", "Сладкий", "Звонкий",
		"Тихий", "Радостный", "Озорной", "Любопытный",
		"Сказочный", "Волшебный", "Дружелюбный", "Задорный", "Умный",
		"Мечтательный", "Игривый", "Счастливый", "Прыгучий", "Крепкий",
	}

	nouns := []string{
		"Мандарин", "Ананас", "Банан", "Арбуз", "Персик",
		"Лимон", "Киви", "Виноград", "Кокос",
		"Котёнок", "Щенок", "Хомяк", "Ёжик", "Зайчик",
		"Мишка", "Лисёнок", "Пингвин", "Бельчонок", "Тигрёнок",
		"Лучик", "Ветерок", "Листик", "Ручеёк",
		"Цветочек", "Грибочек", "Камушек", "Снежок",
		"Робот", "Пароход", "Самолётик", "Паровоз",
		"Дракончик", "Рыцарь", "Волшебник", "Космонавт", "Пират",
	}
